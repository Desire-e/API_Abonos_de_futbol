...
<!-- <body> -->
        ...
        <main class="container d-flex justify-content-center text-center flex-column pb-5">
            ...
            <!-- FORMULARIO -->
             <!-- **MOD CSS MENSAJES DE ERROR -->
                <div class="row justify-content-center text-center pt-4">
                    <div class="wrapper-compra col-12 col-md-12 col-lg-8 col-xl-6 p-5">
                        <h1 class="fs-1 lh-lg mb-4 fw-bold">Formulario de compra</h1>
                        ...
                        -->
                            ...
                            <div class="col-12 text-center">
                                <button type="submit" name="botonComprar" value="ok" class="btn btn-primary btn-lg mt-4">Comprar</button>
                            </div>
                        </form>
                    </div>
                </div>    
